class Game{
    ...
    play(){
        ...
        for(var plr in allPlayers){
            ...
            textSize(20);
            fill("white");
            text(allPlayers.player1.name + "'s Score : " + allPlayers.player1.score, 70, 70);
            text(allPlayers.player2.name + "'s Score : " + allPlayers.player2.score, 70, 130);
